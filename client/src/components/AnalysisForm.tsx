...
const AnalysisForm: React.FC<AnalysisFormProps> = ({ onSubmitAnalysis, isLoading, analysisResult, onWordClick, onClearAnalysisResult }) => {
  ...
  return (
    // Wrap with Form from shadcn/ui which integrates with react-hook-form
    <Form {...form}>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 max-w-4xl mx-auto px-4 mb-8 mt-4">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <FormField
            ...
            name="examType"
            render={({ field }) => (
              <FormItem className="w-32"> {/* Fixed width */}
                <Select
